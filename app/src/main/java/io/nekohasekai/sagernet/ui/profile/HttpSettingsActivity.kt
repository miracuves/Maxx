...
class HttpSettingsActivity : ProfileSettingsActivity<HttpBean>() {
    ...
    override fun PreferenceFragmentCompat.createPreferences(
        ...
        // Set up basic HTTP settings
        findPreference<EditTextPreference>(Key.SERVER_PORT)!!.apply {
            setOnBindEditTextListener(io.nekohasekai.sagernet.database.preference.EditTextPreferenceModifiers.Port)
        }
        
        val username = findPreference<EditTextPreference>(Key.SERVER_USERNAME)!!
        val password = findPreference<EditTextPreference>(Key.SERVER_PASSWORD)!!
        password.summaryProvider = PasswordSummaryProvider
